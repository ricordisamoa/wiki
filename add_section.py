...
def insert(page,level=2,space=True,minorEdit=True):
	header=pywikibot.data.api.Request(site=page.site,action='expandtemplates',text='{{#timel:d xg}}').submit()['expandtemplates']['*']
