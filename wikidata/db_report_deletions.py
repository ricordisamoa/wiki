...
for sysop in admins:
	...
	pywikibot.output(u'{user} has {deletions} deletions, out of which {ns0} in the main namespace; {rem} remaining'.format(user=sysop['name'],deletions=deletions,ns0=ns0,rem=len(admins)-admins.index(sysop)-1))
